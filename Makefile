...
SRCS = blatt3.cpp world.cpp timediscretization.cpp gravitypotential.cpp velocityverlet.cpp observer.cpp particle.cpp ljpotential.cpp observerxyz.cpp world_lc.cpp cell.cpp
